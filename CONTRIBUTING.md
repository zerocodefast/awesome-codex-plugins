...
```bash
pipx install --force "plugin-scanner==2.0.894"
plugin-scanner scan . --format text
```

Expected reviewed wheel SHA256: `632b0dcabb039c932ecd2070a49340f412303359cd3b974cf1bad8a561598083`

If you want to verify the exact wheel before install:

```bash
rm -rf .hol-plugin-scanner-dist
python3 -m pip download --only-binary=:all: --no-deps --dest .hol-plugin-scanner-dist "plugin-scanner==2.0.894"

...
```bash
pipx install --force "plugin-scanner==2.0.863"
plugin-scanner scan . --format text
```

Expected reviewed wheel SHA256: `b3313471b978b97f92e6b323e8cf9dccfc030e506a1c73fe0afe8460b63911a5`

If you want to verify the exact wheel before install:

```bash
rm -rf .hol-plugin-scanner-dist
python3 -m pip download --only-binary=:all: --no-deps --dest .hol-plugin-scanner-dist "plugin-scanner==2.0.863"
